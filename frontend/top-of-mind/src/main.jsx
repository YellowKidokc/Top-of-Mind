...
const fallbackSources = [{ id: 'claude', name: 'Claude', status: 'ready' }, { id: 'gpt', name: 'GPT', status: 'ready' }, { id: 'gemini', name: 'Gemini', status: 'idle' }];
